(function () {
  ...
  chatBox.innerHTML = `
    <div style="background:#0a4aa6;color:#fff;padding:10px;font-size:14px;border-radius:10px 10px 0 0;">
      Quicken Support Chat
    </div>
    <div id="chat-messages" style="flex:1;padding:10px;font-size:13px;overflow-y:auto;">
      <div><strong>Agent:</strong> Hi! How can I help you with Quicken today?</div>
    </div>
    <div style="padding:10px;border-top:1px solid #e5e7eb;">
      <input id="chat-input" type="text" placeholder="Type your message..." 
        style="width:100%;padding:8px;border:1px solid #ccc;border-radius:5px;font-size:13px;">
    </div>
  `;
  ...
  document.addEventListener("keypress", function (e) {
    if (e.target && e.target.id === "chat-input" && e.key === "Enter") {
      ...
      setTimeout(function () {
        messages.innerHTML += `<div><strong>Agent:</strong> Thanks! Our support team will assist you shortly.</div>`;
